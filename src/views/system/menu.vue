 ...
 * @LastEditors: 无言的对话
 * @LastEditTime: 2023-04-21 15:07:37
 * @FilePath: \vue2\src\views\system\menu.vue
-->
<template>
  <div class="menu-content">
    <el-table size="mini" :data="menuList" border style="width: 100%" row-key="id">
